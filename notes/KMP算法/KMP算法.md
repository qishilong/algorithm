...
### [#](https://programmercarl.com/0028.实现strStr.html#kmp有什么用)KMP有什么用
...
### [#](https://programmercarl.com/0028.实现strStr.html#什么是前缀表)什么是前缀表
...
![KMP详解1](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B21-20231209165352373.gif)
...
回顾一下，刚刚匹配的过程在下标5的地方遇到不匹配，模式串是指向f，如图： ![KMP精讲1](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B21-20231209165352398.png)

然后就找到了下标2，指向b，继续匹配：如图： ![KMP精讲2](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B22-20231209165352415.png)
...
![KMP精讲5](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B25-20231209165352458.png)

长度为前1个字符的子串`a`，最长相同前后缀的长度为0。（注意字符串的**前缀是指不包含最后一个字符的所有以第一个字符开头的连续子串**；**后缀是指不包含第一个字符的所有以最后一个字符结尾的连续子串**。）

![KMP精讲6](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B26-20231209165352469.png)

长度为前2个字符的子串`aa`，最长相同前后缀的长度为1。

![KMP精讲7](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B27-20231209165352483.png)

长度为前3个字符的子串`aab`，最长相同前后缀的长度为0。

以此类推： 长度为前4个字符的子串`aaba`，最长相同前后缀的长度为1。 长度为前5个字符的子串`aabaa`，最长相同前后缀的长度为2。 长度为前6个字符的子串`aabaaf`，最长相同前后缀的长度为0。

那么把求得的最长相同前后缀的长度就是对应前缀表的元素，如图： ![KMP精讲8](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B28-20231209165352503.png)

可以看出模式串与前缀表对应位置的数字表示的就是：**下标i之前（包括i）的字符串中，有多大长度的相同前缀后缀。**

再来看一下如何利用 前缀表找到 当字符不匹配的时候应该指针应该移动的位置。如动画所示：

![KMP精讲2](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B22-20231209165352678.gif)
...
![KMP精讲4](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B24-20231209165352783.gif)
...
### [#](https://programmercarl.com/0028.实现strStr.html#构造next数组)构造next数组
...
![KMP精讲3](https://qiniucloud.qishilong.space/images/KMP%E7%B2%BE%E8%AE%B23-20231209165352872.gif)

得到了next数组之后，就要用这个来做匹配了。

### [#](https://programmercarl.com/0028.实现strStr.html#使用next数组来做匹配)使用next数组来做匹配
...
### [#](https://programmercarl.com/0028.实现strStr.html#前缀表统一减一-c-代码实现)前缀表统一减一 C++代码实现
...
### [#](https://programmercarl.com/0028.实现strStr.html#前缀表-不减一-c-实现)前缀表（不减一）C++实现
...
## [#](https://programmercarl.com/0028.实现strStr.html#总结)总结
